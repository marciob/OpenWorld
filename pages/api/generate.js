  ...
  if (req.method === "POST") {
    ...
    while (true) {
      try {
        ...
        console.log(
          "End of existing pages reached or error reading pages:",
          error.message
        );
        break;
      }
    ...
    console.log(`PAGEINDEX before API call: ${pageIndex}, ForkID: ${forkId}`);
    const promptText =
      pageIndex > 1
    ...
    try {
      ...
      // print the story output from OpenAI
      console.log("Story generated by OpenAI:", storyContent);
